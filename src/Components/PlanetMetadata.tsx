...
const PlanetMetadata: React.FC<PlanetMetadataProps> = ({ selectedPlanet}) => {
    ...
    return (
        <div className='flex mobile:flex-col mobile:children:mx-4 mobile:children:px-[0.7rem] children:px-[1.575rem] laptop:flex-row laptop:justify-between children:border-2 children:border-white tablet:children:w-[10.25rem] tablet:children:h-[5.5625rem] laptop:px-[10.3125rem] laptop:children:h-[8rem] laptop:children:w-[15.9375rem] font-spartan text-white children:flex children:flex-col children:border-opacity-20'>
            <div className='flex mobile:flex-row mobile:justify-between laptop:flex-col laptop:justify-center'>
